...
<br>showing <?php echo e($page); ?> out of <?php echo e($total); ?><br><br>
<?php echo $__env->make('partials.pagination', ['url' => 'home/category', 'total' => $total], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
